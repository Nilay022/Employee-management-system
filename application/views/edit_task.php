...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <h3 class="mt-3 mb-5" style="margin-left: 10%">edit Task</h3>
          <form style=" width: 75% ; margin-left: 10%" name="form" method="post" action="<?php echo base_url(); ?>update" >
            <?php foreach ($task as $data) { ?>

          <input type="hidden" name="tid" class="form-control" value="<?php echo  $data->tid ?>">
   
          <label>Task</label>
          <div class="form-group">
          <input type="text" name="task" class="form-control" value="<?php echo $data->task; ?>"  placeholder="Enter task">
          ...
          <span><?php echo form_error('employee') ?></span> 
          </div>
          ...
          <div class="form-group">
            ...
            <input type="date" name="due_date" value="<?php echo $data->due_date; ?>" class="form-control"></input>
